...
<html>
    <head>
        ...
        <!--CARGA ARCHIVO ICONOS { !! Html::script('/assets/js/fontawesome-all.js') !!} -->
    ...
    <body class="interna">
        @yield('section')
            ...
            <div class="texto-encabezado text-xs-center wow zoomInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                <div class="container">
                    @yield('text')
                </div>
            </div>
        ...
        <section class="text-justify con1">
            @yield('con1')  
        </section>

        <section class="text-justify p-y-1">
            @yield('con2')            
        </section>
